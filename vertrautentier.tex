...
\hypersetup{
  ...
  pdfkeywords = {Xaver Stiensmeier, Gründungsmanagement, Fragebogen},
  pdftitle    = {Fragebogen - Gründungsmanagement},
  colorlinks,
  citecolor=black,
  filecolor=black,
  linkcolor=black,
...
\begin{document}
\title{\vspace{-1.5cm}\href{https://ulisses-regelwiki.de/GR_Vertraute.html}{Vertrautentier}\vspace{-1.5cm}}
\date{}
\maketitle
\thispagestyle{empty}
\begin{center}
...
\begin{tabularx}{1.2\textwidth}{X|S|X|S|X|S|X|S}
   \textbf{Größe} & \tb{0.65cm}{fsize} & \textbf{Gewicht} & \tb{0.65cm}{fweight} & \textbf{Alter} & \eigenschaft{fage} & \textbf{Geschlecht} & \eigenschaft{sex} \\
\end{tabularx}%
}\vspace{0.5cm}
\makebox[\textwidth]{%
\begin{tabularx}{1.2\textwidth}{X|S|X|S|X|S|X|S}
...
\subsubsection*{\href{https://ulisses-regelwiki.de/sonderfertigkeiten.html}{Sonderfertigkeiten}}
\makebox[\textwidth]{%
\begin{tabularx}{1.2\textwidth}{X|X|X|X}
